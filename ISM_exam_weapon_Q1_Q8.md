...
Based on exam patterns and references from **Statistics for Business and Economics (Anderson)**.

Recommended chapters:
- Chapter 3 — Descriptive statistics and correlation
...
The Department of Environment in Delhi collected the following paired monthly data (average temperature in °C and average household electricity usage in kWh):
...
(i) Calculate Karl Pearson’s coefficient of correlation \( r \).  
(ii) Interpret the result in one sentence.
...
\[
r = \frac{312}{320.807} \approx 0.973
\]
...
Monthly demand (thousands of requests)
...
Higher \( \alpha \) reacts faster to spikes.
...
\[
t = \frac{\bar{d}}{s_d/\sqrt{n}} \approx 13.56
\]
...
Observation \(x=25\) is closer to \(22\).

Most likely component → **Quick eaters**.
...
\[
z = \frac{0.60-0.54}{0.04236} \approx 1.42
\]
